...
const ConfirmPayment: React.FC <IPricing> = ({amount}) => {
  ...
  <View style={{ paddingTop: 30, marginHorizontal: 15, marginBottom: 20}}>
    <Text style={{ fontSize: 22, color: '#000' }}>Choose Payment Method</Text>
  </View>
  ...
  {/* PAYMENT CARDS */}
    ...
    <View style={{marginTop: 100}}>
      <TouchableOpacity style={{backgroundColor: '#46BA7F', borderRadius: 20, paddingHorizontal: 40, paddingVertical: 20, marginHorizontal: 15}}>
