  ...
  return (
    ...
    padding: 15,}}>
        ...
        <TouchableOpacity style={styles.addPackage}>
            ...
            color= '#fff'
            />
            <Text style={{fontSize: 18, color: '#fff', margin: 'auto' , paddingLeft: 10}}>
                Add Package
            </Text>
        </TouchableOpacity>
      </View>
      ...
      <DeliveryInfo title='Delivery type' input='Doorstep delivery' bgColor='#F3F4B7'/>
      ...
      <DeliveryInfo title='Package Description' input='Electronic'/>
        ...
        {/* Receiver's Card */}
        <InfoCard name='John Doe' number='+2348108960610' address='N0.2 Jasmine street, Lekki, Lagos, Nigeria.' bgColor='#F5F4EF'/>
        ...
        {/* Sender Card */}
        <InfoCard name='John Doe' number='+2348108960610' address='N0.2 Jasmine St. Yaba, Lagos.' bgColor='#EFF5EF' editIcon= {true}/>
